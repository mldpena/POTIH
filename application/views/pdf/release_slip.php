		...
		{ 
			if (!$print_description) 
			{
				$html = "
					<table>
						<tr>
							<td style=\"width:".$column_width[0].";\" class=\"tdheader tddata\">".$detail[$i]["quantity"]."</td>
							<td style=\"width:".$column_width[1].";\" class=\"tdheader tddata\">".$detail[$i]["product"]."</td>
							<td style=\"width:".$column_width[2].";\" class=\"tdheader tddata\">".$detail[$i]["item_code"]."</td>
							<td style=\"width:".$column_width[3].";\" class=\"tdheader tddata\">".$detail[$i]["memo"]."</td>
						</tr>
					</table>";
			...
			if (!empty($detail[$i]['description']))
			{
				$html = "
					<table>
						<tr>
							<td style=\"width:".$column_width[0].";\" class=\"tdheader tddata\"></td>
							<td colspan = \"3\" style=\"width:645px;\" class=\"tdheader tddata\">".$detail[$i]["description"]."</td>
						</tr>
					</table>";
