<?php
	...
	$column_width = array("55px","330px","95px","160px","60px");
	...
	while ($is_finished == FALSE) 
	{
		...
		$pdf->writeHTMLCell('', '', $x, $y,'ITEM REQUEST', 0, 1, 0, true, 'C', true);
		...
		$pdf->writeHTMLCell('', '', $x, $y,'Request To : '.$request_to, 0, 1, 0, true, 'L', true);
