<?php
	...
	$filename 	= 'delivery_receive_transactions('.date('Y-m-d').').xlsx';
	$header 	= array('REFERENCE #', 'FROM BRANCH', 'TO BRANCH', 'ENTRY DATE', 'MEMO', 'TOTAL QUANTITY', 'STATUS');
	$formats 	= array('String', 'String', 'String', 'String', 'String', 'Number-0', 'String');
	$align 		= array('Center', 'Center', 'Center', 'Center', 'Left', 'Center', 'Center');
	$width 		= array(20, 20, 20, 20, 60, 20, 20);
	$count 		= 7;
