<div class="main-content pull-right">
	<div class="breadcrumbs-panel">
		<ol class="breadcrumb">
			...
			<li class="active"><a href="<?= base_url() ?>sales/list">Sales Invoice List</a></li>
		</ol>
	</div>
	<div class="content-form">
		<div class="form-header">Sales Invoice List</div>
		<div class="form-body">
					...
					<tr>
						...
						<td colspan="3">
							<select class="form-control" id="status">
								...
								<option value="3">No Delivery</option>
			...
			<div class="max-row">
				<button class="btn btn-primary" id="create_new">Create New Sales Invoice</button>
			</div>
