<div class="main-content pull-right">
	<div class="breadcrumbs-panel">
		<ol class="breadcrumb">
			...
			<li class="active"><a href="<?= base_url() ?>reservation/list">Sales Reservation List</a></li>
		</ol>
	</div>
	<div class="content-form">
		<div class="form-header">Sales Reservation List</div>
		<div class="form-body">
					...
					<tr>
						...
						<td colspan="3">
							<select class="form-control" id="status">
								...
								<option value="3">Not Sold</option>
								<option value="4">Excess</option>
								<option value="5">Not Sold / Incomplete</option>
							</select>
						</td>
					</tr>
				</table>
			...
			<div class="max-row">
				<button class="btn btn-primary" id="create_new">Create New Sales Reservation</button>
			</div>
