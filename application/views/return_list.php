<div class="main-content pull-right">
	<div class="breadcrumbs-panel">
		<ol class="breadcrumb">
			...
			<li class="active"><a href="<?= base_url() ?>productreturn/list">Return List</a></li>
		</ol>
	</div>
	<div class="content-form">
		<div class="form-header">Return List</div>
		<div class="form-body">
			...
			<div class="max-row">
				<a href="<?= base_url() ?>productreturn/detail">
					<button class="btn btn-primary">Create New Return</button>
				</a>
			</div>
			<div class="max-row">
