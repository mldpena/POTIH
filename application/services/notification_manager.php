...
class Notification_Manager
{
	...
	public function get_header_notifications()
	{
		...
		$response['notification']['stock_request_count'] 	= !$view_page_permission['stock_request'] ? 0 : $this->_CI->request_model->get_stock_request_notification_count('REQUESTED_BY_OTHER_BRANCH_NO_DELIVERY');
		...
		$response['notification']['stock_request_due_incomplete_count'] = !$view_page_permission['stock_request'] ? 0 : $this->_CI->request_model->get_stock_request_notification_count('DUE_INCOMPLETE');
		$response['notification']['stock_request_due_no_delivery_count'] = !$view_page_permission['stock_request'] ? 0 : $this->_CI->request_model->get_stock_request_notification_count('DUE_NO_DELIVERY');
