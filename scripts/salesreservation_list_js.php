<script type="text/javascript">
	var isNotified = "<?= $this->uri->segment(3) ?>";
	...
	var tableHelper = new TableHelper(	{ tableObject : myjstbl, tableArray : colarray }, 
										{ baseURL : "<?= base_url() ?>", 
										  ...
										  notFoundMessage : 'No sales reservation entry found!',
	...
	function getSearchFilterValues()
	{
		...
		var filterValues = 	{ 
								fnc 	 		: 'search_sales_reservation_list', 
	...
	{
		triggerSearchRequest();
		build_message_box('messagebox_1','Sales Reservation entry successfully deleted!','success');
	}
